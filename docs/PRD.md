...
- [载具专属技能](./design/VEHICLE_SKILLS.md)  
...
| 摩托车 | 是 | 高速压制 | 甩尾倒油 |
| 公路车 | 否 P1 | 直线爆发 | 趴体冲刺 |
| 外卖三轮等 | 否 P1 | 抗控/诱饵等 | 见技能文档 |
| **迈巴赫** | 否 **P2** | 喜剧超载具 | **拿来吧你**（抢配送中外卖） |

换车仅在换车站；读条 **1.5s**；**换车即换技**。数值见 [NUMBERS.md](./specs/NUMBERS.md)、[VEHICLE_SKILLS.md](./design/VEHICLE_SKILLS.md)。

### 5.4 玩家互动与载具技

**MVP 技能：** 单车铃铛 / 电动冲刺 / 摩托倒油。  
**P2 招牌：** 迈巴赫 **「拿来吧你」** — 范围内抢夺对方「配送中」订单（0.45s 预警圈、保护态免疫、CD 22s；若自己已持单则原包裹掉落可捡，制造混战）。  
**扩展池：** 公路车趴体、三轮盾、滑板漂移、出租车假单、洒水车湿滑带、巡逻临检、空投单等 — 见技能文档 §4。

**公平硬规则：**

- 减益/抢夺有前摇与预警  
- 主动 CD ≥12s（抢夺技更长）  
- 送达前 2s 保护态（不可打断、不可被「拿来吧你」）  
- 正规抢夺仅迈巴赫 `SK_YOINK`；干扰分上限 60  
- 对外文案用惊吓/甩尾/拿来吧你，不用攻击击杀  
